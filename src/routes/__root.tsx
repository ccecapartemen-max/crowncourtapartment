...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Crown Court Executive Condominium" },
      { name: "description", content: "Hunian eksekutif premium di Jakarta — minimalis, modern, dan tenang." },
      { property: "og:title", content: "Crown Court Executive Condominium" },
      { property: "og:description", content: "Hunian eksekutif premium di Jakarta — minimalis, modern, dan tenang." },
